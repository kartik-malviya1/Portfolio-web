...
const Navbar = () => {
  return (
    <nav className="items-center mb-20 flex gap-[1200px] fixed backdrop-blur-[1px]">
      ...
      <div className='m-8 flex items-center justify-center gap-4 text-2xl'>
        <a href="https://www.linkedin.com/in/kartik-malviya-ab205025a/" target="_blank" rel="noopener noreferrer">
          <FaLinkedin className='cursor-pointer hover:text-blue-400 ease-in-out duration-200' />
        </a>
        <a href="https://github.com/kartik-malviya1" target="_blank" rel="noopener noreferrer">
          <FaGithub className='cursor-pointer hover:text-blue-400 duration-200 ease-in-out'/>
        </a>
